...
public class SpeedoMeterView extends View {
    ...
    public SpeedoMeterView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray ta = getContext().obtainStyledAttributes(attrs, R.styleable.ec_arc_progress);
        needlecolor=ta.getColor(R.styleable.ec_arc_progress_ec_arc_container_color,Color.RED);
        linecolor=ta.getColor(R.styleable.ec_arc_progress_ec_arc_container_color,Color.TRANSPARENT);
        drawable = ta.getDrawable(R.styleable.ec_arc_progress_ec_arc_unit_text_color);
        isborder=ta.getBoolean(R.styleable.ec_arc_progress_ec_arc_container_color,false);
